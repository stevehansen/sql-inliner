...
internal static class Program
{
    private static int Main(string[] args)
    {
        ...
        var flattenDerivedTablesOption = new Option<bool>("--flatten-derived-tables", "-fdt") { Description = "Flatten derived tables (subqueries) produced by inlining into the outer query. Experimental: handles single-table and multi-table (JOIN) subqueries without GROUP BY, HAVING, TOP, DISTINCT, or UNION" };
